...
('PSY', SEQ_LECTURE_NO.NEXTVAL, 1, '일반심리학', '3', DEFAULT, 30, '목', '8');
INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.CURRVAL, 1, '일반심리학', '3', DEFAULT, 30, '목', '9');

INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.NEXTVAL, 1, '발달심리학', '3', DEFAULT, 30, '수', '2');
INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.CURRVAL, 1, '발달심리학', '3', DEFAULT, 30, '수', '3');

INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.NEXTVAL, 1, '인지심리학', '3', DEFAULT, 30, '월', '5');
INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.CURRVAL, 1, '인지심리학', '3', DEFAULT, 30, '월', '6');

INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.NEXTVAL, 1, '상담심리학', '3', DEFAULT, 40, '금', '1');
INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.CURRVAL, 1, '상담심리학', '3', DEFAULT, 40, '금', '2');


INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.NEXTVAL, 1, '학습심리학', '3', DEFAULT, 40, '화', '4');
INSERT INTO LECTURE VALUES
('PSY', SEQ_LECTURE_NO.CURRVAL, 1, '학습심리학', '3', DEFAULT, 40, '화', '5');

INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.NEXTVAL, 2, '응용생물학', '3', DEFAULT, 40, '수', '6');
INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.CURRVAL, 2, '응용생물학', '3', DEFAULT, 40, '수', '7');

INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.NEXTVAL, 2, '응용생화학', '3', DEFAULT, 40, '월', '2');
INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.CURRVAL, 2, '응용생화학', '3', DEFAULT, 40, '월', '3');

INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.NEXTVAL, 2, '생명공학실험', '3', DEFAULT, 40, '금', '1');
INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.CURRVAL, 2, '생명공학실험', '3', DEFAULT, 40, '금', '2');

INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.NEXTVAL, 2, '화공열역학', '3', DEFAULT, 40, '화', '4');
INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.CURRVAL, 2, '화공열역학', '3', DEFAULT, 40, '화', '5');

INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.NEXTVAL, 2, '화공유체역학', '3', DEFAULT, 30, '목', '8');
INSERT INTO LECTURE VALUES
('CHE', SEQ_LECTURE_NO.CURRVAL, 2, '화공유체역학', '3', DEFAULT, 30, '목', '9');

INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.NEXTVAL, 3, '컴퓨터프로그래밍', '3', DEFAULT, 40, '화', '8');
INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.CURRVAL, 3, '컴퓨터프로그래밍', '3', DEFAULT, 40, '화', '9');

INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.NEXTVAL, 3, '디지털회로개론', '3', DEFAULT, 40, '월', '2');
INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.CURRVAL, 3, '디지털회로개론', '3', DEFAULT, 40, '월', '3');

INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.NEXTVAL, 3, '컴퓨터공학실험', '3', DEFAULT, 40, '목', '6');
INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.CURRVAL, 3, '컴퓨터공학실험', '3', DEFAULT, 40, '목', '7');

INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.NEXTVAL, 3, '자바언어', '3', DEFAULT, 40, '금', '3');
INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.CURRVAL, 3, '자바언어', '3', DEFAULT, 40, '금', '4');

INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.NEXTVAL, 3, '운영체제', '3', DEFAULT, 40, '수', '4');
INSERT INTO LECTURE VALUES
('CSE', SEQ_LECTURE_NO.CURRVAL, 3, '운영체제', '3', DEFAULT, 40, '수', '5');

INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.NEXTVAL, 4, '회로이론', '3', DEFAULT, 40, '월', '1');
INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.CURRVAL, 4, '회로이론', '3', DEFAULT, 40, '월', '2');

INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.NEXTVAL, 4, '전자기학', '3', DEFAULT, 40, '화', '3');
INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.CURRVAL, 4, '전자기학', '3', DEFAULT, 40, '화', '4');

INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.NEXTVAL, 4, '공학수학', '3', DEFAULT, 40, '수', '5');
INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.CURRVAL, 4, '공학수학', '3', DEFAULT, 40, '수', '6');

INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.NEXTVAL, 4, '전력공학', '3', DEFAULT, 40, '목', '7');
INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.CURRVAL, 4, '전력공학', '3', DEFAULT, 40, '목', '8');

INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.NEXTVAL, 4, '전력설비', '3', DEFAULT, 40, '금', '4');
INSERT INTO LECTURE VALUES
('ELE', SEQ_LECTURE_NO.CURRVAL, 4, '전력설비', '3', DEFAULT, 40, '금', '5');

INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.NEXTVAL, 5, '영문학개론', '3', DEFAULT, 40, '목', '5');
INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.CURRVAL, 5, '영문학개론', '3', DEFAULT, 40, '목', '6');

INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.NEXTVAL, 5, '영미수필', '3', DEFAULT, 40, '금', '8');
INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.CURRVAL, 5, '영미수필', '3', DEFAULT, 40, '금', '9');

INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.NEXTVAL, 5, '영문학작문', '3', DEFAULT, 40, '월', '1');
INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.CURRVAL, 5, '영문학작문', '3', DEFAULT, 40, '월', '2');

INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.NEXTVAL, 5, '셰익스피어', '3', DEFAULT, 40, '화', '2');
INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.CURRVAL, 5, '셰익스피어', '3', DEFAULT, 40, '화', '3');

INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.NEXTVAL, 5, '현대미국소설', '3', DEFAULT, 40, '수', '7');
INSERT INTO LECTURE VALUES
('ENG', SEQ_LECTURE_NO.CURRVAL, 5, '현대미국소설', '3', DEFAULT, 40, '수', '8');

INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.NEXTVAL, 6, '경제학원론', '3', DEFAULT, 40, '금', '8');
INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.CURRVAL, 6, '경제학원론', '3', DEFAULT, 40, '금', '9');

INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.NEXTVAL, 6, '경제통계학', '3', DEFAULT, 40, '목', '6');
INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.CURRVAL, 6, '경제통계학', '3', DEFAULT, 40, '목', '7');

INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.NEXTVAL, 6, '미시경제학', '3', DEFAULT, 40, '수', '4');
INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.CURRVAL, 6, '미시경제학', '3', DEFAULT, 40, '수', '5');

INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.NEXTVAL, 6, '거시경제학', '3', DEFAULT, 40, '화', '2');
INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.CURRVAL, 6, '거시경제학', '3', DEFAULT, 40, '화', '3');

INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.NEXTVAL, 6, '계량경제학', '3', DEFAULT, 40, '월', '1');
INSERT INTO LECTURE VALUES
('ECO', SEQ_LECTURE_NO.CURRVAL, 6, '계량경제학', '3', DEFAULT, 40, '월', '2');

INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.NEXTVAL, 7, '축구학', '3', DEFAULT, 40, '목', '5');
INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.CURRVAL, 7, '축구학', '3', DEFAULT, 40, '목', '6');

INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.NEXTVAL, 7, '농구학', '3', DEFAULT, 40, '월', '7');
INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.CURRVAL, 7, '농구학', '3', DEFAULT, 40, '월', '8');

INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.NEXTVAL, 7, '야구학', '3', DEFAULT, 40, '화', '3');
INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.CURRVAL, 7, '야구학', '3', DEFAULT, 40, '화', '4');

INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.NEXTVAL, 7, '배구학', '3', DEFAULT, 40, '금', '1');
INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.CURRVAL, 7, '배구학', '3', DEFAULT, 40, '금', '2');

INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.NEXTVAL, 7, '탁구학', '3', DEFAULT, 40, '수', '8');
INSERT INTO LECTURE VALUES
('PHY', SEQ_LECTURE_NO.CURRVAL, 7, '탁구학', '3', DEFAULT, 40, '수', '9');

INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.NEXTVAL, 8, '관리회계', '3', DEFAULT, 40, '화', '1');
INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.CURRVAL, 8, '관리회계', '3', DEFAULT, 40, '화', '2');

INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.NEXTVAL, 8, '경영통계학', '3', DEFAULT, 40, '수', '4');
INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.CURRVAL, 8, '경영통계학', '3', DEFAULT, 40, '수', '5');

INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.NEXTVAL, 8, '회계학원론', '3', DEFAULT, 40, '목', '6');
INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.CURRVAL, 8, '회계학원론', '3', DEFAULT, 40, '목', '7');

INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.NEXTVAL, 8, '재무관리', '3', DEFAULT, 40, '금', '1');
INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.CURRVAL, 8, '재무관리', '3', DEFAULT, 40, '금', '2');

INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.NEXTVAL, 8, '경영전략', '3', DEFAULT, 40, '월', '7');
INSERT INTO LECTURE VALUES
('BUS', SEQ_LECTURE_NO.CURRVAL, 8, '경영전략', '3', DEFAULT, 40, '월', '8');

INSERT INTO LECTURE VALUES
('GEC', SEQ_LECTURE_NO.NEXTVAL, 9, '수학의정석', '3', DEFAULT, 40, '월', '2');
INSERT INTO LECTURE VALUES
('GEC', SEQ_LECTURE_NO.CURRVAL, 9, '수학의정석', '3', DEFAULT, 40, '월', '3');

INSERT INTO LECTURE VALUES
('GEC', SEQ_LECTURE_NO.NEXTVAL, 10, '과학의정석', '3', DEFAULT, 40, '수', '4');
INSERT INTO LECTURE VALUES
('GEC', SEQ_LECTURE_NO.CURRVAL, 10, '과학의정석', '3', DEFAULT, 40, '수', '5');

INSERT INTO LECTURE VALUES
('GEC', SEQ_LECTURE_NO.NEXTVAL, 9, '경제의정석', '3', DEFAULT, 40, '금', '1');
INSERT INTO LECTURE VALUES
('GEC', SEQ_LECTURE_NO.CURRVAL, 9, '경제의정석', '3', DEFAULT, 40, '금', '2');
